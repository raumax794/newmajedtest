    ...
    function(e) {
        window.BNS = new function() {
            var e = {
                ...
                n = function() {
                    e.prevScroll = (window.pageYOffset || document.documentElement.scrollTop) - (document.documentElement.clientTop || 0), e.prevPosition = document.body.style.position, e.prevOverflow = document.body.style.overflow, e.prevClasses = document.body.className
                };
            return {
                set: function(t) {
                    e.classes = t.classes
                ...
                on: function(i) {
                    ...
                    document.body.className = document.body.className + " " + e.classes + " " + i, t && (document.body.style.top = -e.prevScroll + "px", document.body.style.position = "fixed", document.body.style.overflow = "hidden"), bodyScrollLock.disableBodyScroll(document.querySelector("#nav"), {
                ...
                off: function() {
                    if (t) {
                        if (!e.on) return;
                        e.on = !1, document.body.className = e.prevClasses, document.body.style.top = 0, document.body.style.position = e.prevPosition, document.body.style.overflow = e.prevOverflow, window.scrollTo(0, e.prevScroll)
                    }
